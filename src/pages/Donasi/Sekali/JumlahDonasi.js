  ...
  return (
    <>
      {pilihanMetode ? (
        <div className="w-screen h-screen flex justify-center">
          <div className="container top-y-10  mx-auto max-w-[430px] h-screen">
            ...
            >
              {/* <div
            className='mt-[20px] flex flex-row items-center cursor-pointer'
            onClick={() => pilihMetode({metode: 'bank_transfer', nama: 'bca'})}
          >
            <div className='w-[60px] flex justify-center'>
              <svg
                width={54}
                ...
                xmlns='http://www.w3.org/2000/svg'
              >
                <g clipPath='url(#clip0_5401_20028)'>
                  <path
                    d='M29.315 8.07327C32.7311 6.52382 33.2363 1.46753 28.3772 1.46753H22.75L20.6704 5.54518H21.649L19.1616 15.2907H25.6859C30.4456 15.3314 32.5863 9.72666 29.315 8.07327ZM25.6859 11.7432H24.0548L24.6664 9.54134H26.2159C28.0508 9.90824 26.9092 11.8247 25.6859 11.7432ZM26.6645 7.05383H25.2782L25.6859 5.13736H27.2353C28.7325 5.50438 27.4393 7.13544 26.6645 7.05383Z'
                    fill='#005FAF'
                  />
                  <path
                    d='M42.6735 6.67521L44.8098 2.904L41.9191 1.39618L41.5421 1.86153C39.9827 1.03606 31.817 2.17582 31.3057 10.2309C31.6113 16.9882 39.183 15.7727 39.9257 15.3439L42.0082 11.039C39.9686 12.3824 35.7924 13.0273 35.6158 8.99178C35.9821 5.66395 39.9111 4.42118 42.6735 6.67521ZM53.3338 1.4675H46.7664L44.6789 5.42309H45.7513L40.802 15.2907H45.5926L46.5761 12.9107H49.5168L49.5902 15.2907H54.0001L53.3338 1.4675ZM47.9085 9.70617L49.5167 5.86727L49.59 9.70617H47.9085Z'
                    fill='#005FAF'
                  />
                  <path
                ...
                <defs>
                  <clipPath id='clip0_5401_20028'>
                    <rect width={54} height='16.9344' fill='white' />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <p className='ml-[30px] text-sm font-normal'>BCA Virtual Account</p>
          </div>
          <hr style={{border: '0.5px solid #E4E4E480'}} /> */}
              <div
                className="flex flex-row items-center cursor-pointer"
            ...
            className="flex flex-row items-center cursor-pointer"
            onClick={() =>
              pilihMetode({ metode: "bank_transfer", nama: "mandiri" })
            }
          >
            <div className="w-[60px] flex justify-center">
              <svg
              ...
              >
                <path
                  d="M0.0558505 11.6527C0.0558505 10.8714 0.0421981 10.2173 0 9.63214H1.47756L1.54768 10.6362H1.58864C1.92312 10.1062 2.53623 9.47824 3.6793 9.47824C4.57167 9.47824 5.26794 9.98089 5.56084 10.733H5.58939C5.82644 10.357 6.10445 10.0777 6.42466 9.88347C6.80134 9.61787 7.2345 9.47824 7.79114 9.47824C8.92056 9.47824 10.0624 10.2446 10.0624 12.4203V16.4192H8.38998V12.6698C8.38998 11.5416 7.99965 10.8714 7.1774 10.8714C6.59222 10.8714 6.15968 11.2909 5.9791 11.7787C5.92885 11.9648 5.90073 12.1562 5.89533 12.349V16.4198H4.22292V12.488C4
                  fill="#0D2B5B"
                />
                <path
          ...
          <hr style={{ border: "0.5px solid #E4E4E480" }} /> */}
              {/* <div
            className='flex flex-row items-center cursor-pointer'
            onClick={() => pilihMetode({metode: 'bank_transfer', nama: 'bri'})}
          >
            <div className='w-[60px] flex justify-center'>
              <svg
                width={54}
              ...
              >
                <path
                  fillRule='evenodd'
                  clipRule='evenodd'
                  d='M1.7702 3.57428C1.13931 3.82589 0.708237 4.25696 0.313595 5.03017C-0.0124745 5.66892 -0.0274745 6.10535 0.0200253 13.6157L0.070025 21.5281L0.57038 22.1838C1.50466 23.4083 1.23859 23.3749 10.0346 23.3749H17.9635L18.566 22.9688C18.8974 22.7456 19.3514 22.2917 19.5746 21.9603L19.9807 21.3578V13.375V5.39213L19.5746 4.78964C19.3514 4.45821 18.8974 4.00428 18.566 3.78107L17.9635 3.375L10.0882 3.38625C5.34072 3.39321 2.03698 3.46786 1.7702 3.57428ZM6.17446 4.99356C7.41856 5.46356 8.14338 6.73766 7.91981 8.06159C7.80928 8.71551 7.50571 9.10462 5.56071 11.0855L3.32858 13.3589L5.40929 15.5524C7.80499 18.0781 8.06856 18.6119 7.56821 19.9226C7.19053 20.9112 6.36821 21.5417 5.11357 21.8049C3.8959 22.0603 3.10251 21.8617 2.58823 21.1728C2.22091 20.681 2.21287 20.5108 2.21287 13.2914C2.21287 6.16392 2.22502 5.89892 2.57001 5.51553C2.76644 5.29713 3.08787 5.05285 3.2843 4.97231C3.80412 4.75964 5.59 4.77267 6.17446 4.99356ZM12.2518 5.27196C13.3878 6.11356 13.8078 7.32177 13.3673 8.48069C13.2657 8.74801 12.2612 9.92247 11.1352 11.0903C10.0091 12.2584 9.08784 13.2828 9.08784 13.3669C9.08784 13.4512 10.8666 15.3382 13.0407 17.5601C15.2148 19.7821 16.936 21.658 16.8655 21.7285C16.795 21.7992 15.0459 21.8831 12.9785 21.9149L9.21981 21.9728L9.32266 21.5578C9.37927 21.3296 9.55391 20.7008 9.71087 20.1606C10.2661 18.2487 9.74587 16.7474 7.8291 14.7294L6.53178 13.3637L6.97017 12.8783C7.21124 12.6112 7.88945 11.866 8.47731 11.2223C9.12498 10.513 9.63177 9.76604 9.76337 9.32658C10.0975 8.21123 10.0305 6.44838 9.61927 5.54231L9.26588 4.76321L10.5103 4.83356C11.4066 4.88428 11.8941 5.00696 12.2518 5.27196ZM17.3362 5.49767L17.8378 6.05927L17.8291 12.7082L17.8203 19.3571L14.9719 16.4289C13.4053 14.8183 12.1235 13.4439 12.1235 13.3748C12.1235 13.3055 12.768 12.5601 13.5555 11.7184C14.3432 10.8764 15.1021 9.9139 15.2419 9.57908C15.7941 8.25783 15.7314 6.65999 15.0662 5.09053C14.9334 4.77732 14.993 4.75928 15.8787 4.84446C16.6635 4.91981 16.9242 5.03678 17.3362 5.49767ZM22.1235 13.3864V21.7908L26.4585 21.7346L30.7935 21.6785L31.9927 21.0876C33.9138 20.1412 34.734 18.6394 34.5849 16.3416C34.4915 14.903 34.1875 14.2048 33.1783 13.1098C32.5552 12.4337 32.5088 12.3237 32.7601 12.1153C33.3493 11.6262 33.7308 10.5587 33.7267 9.4089C33.7217 7.99837 33.3033 7.04141 32.3256 6.20445C31.0749 5.13374 30.2827 4.98214 25.9422 4.98214H22.1235V13.3864ZM35.8734 13.375V21.7678H37.3913H38.9091V18.6428V15.5178H39.8668H40.8243L43.0061 18.6428L45.1879 21.7678H47.0696H48.9514L48.5166 21.1874C47.7518 20.1669 44.4448 15.3849 44.4448 15.2994C44.4448 15.2542 44.7784 15.1173 45.1859 14.9951C46.2564 14.6744 47.6961 13.1794 48.0971 11.9717C48.8093 9.82747 48.168 7.28909 46.6146 6.10445C45.3216 5.11821 44.5138 4.98214 39.9481 4.98214H35.8734V13.375ZM49.9805 13.375V21.7678H51.5877H53.1948V13.375V4.98214H51.5877H49.9805V13.375ZM30.1104 8.46908C30.6794 9.03801 30.7319 9.17301 30.654 9.86479C30.6065 10.286 30.4263 10.8464 30.2536 11.11L29.9395 11.5892H27.5494H25.1592V9.71426V7.83927H27.3199H29.4806L30.1104 8.46908ZM44.5482 8.59551C45.0727 9.16819 45.1591 9.38855 45.1591 10.1519C45.1591 10.891 45.0661 11.1471 44.6071 11.6698C43.8895 12.4871 43.1032 12.6855 40.8311 12.6223L38.9984 12.5714L38.9484 10.1918L38.8986 7.81212L41.4181 7.87034L43.9375 7.92855L44.5482 8.59551ZM30.3206 14.6723C31.5654 15.3119 31.8938 17.046 30.9556 18.0253C30.2722 18.7387 29.5447 18.9085 27.1681 18.9096L25.1592 18.9106V16.6785V14.4464L27.5253 14.4491C29.0474 14.4507 30.0444 14.5303 30.3206 14.6723Z'
                  fill='#00529C'
                />
              </svg>
            </div>
            <p className='ml-[30px] text-sm font-normal'>BRI Virtual Account</p>
          </div>
          <hr style={{border: '0.5px solid #E4E4E480'}} /> */}
              <div
                className="flex flex-row items-center cursor-pointer"
            ...
            {/* <div className="mt-[20px] bg-[#E4E4E44D]">
          <p className="px-[20px] py-[22px] flex flex-col font-medium text-small">
            Transfer bank (verifikasi manual 1x24 jam, minimal Rp10,000)
          </p>
        </div>
        <div
          className={`space-y-6 mx-[20px] my[24px] ${
        ...
        >
          <div
            className="mt-[24px] flex flex-row items-center cursor-pointer"
            onClick={() =>
              pilihMetode({ metode: "transfer_manual", nama: "bri" })
            }
          >
            <div className="w-[60px] flex justify-center">
              <svg
            ...
            <p className="ml-[30px]  text-sm font-normal">Transfer BRI</p>
          </div>
        </div> */}
            <div className="bg-[#E4E4E44D] my-[24px]">
              <p className="px-[20px] py-[22px] flex flex-col font-medium text-small">
