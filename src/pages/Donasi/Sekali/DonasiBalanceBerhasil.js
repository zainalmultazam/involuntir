  ...
  return (
    <div className="mx-auto" style={{ maxWidth: '430px' }}>
      <div className="flex items-center justify-center h-[90vh] flex-col text-center">
        ...
        <h1 className="text-2xl font-medium text-[#34A853] mt-[10px]">
          Transaksi Berhasil
        </h1>
        <p className="text-lg font-normal max-w-[285px] mt-[16px]">
          Terima kasih atas bantuannya, semoga rezekimu semakin lancar!
        </p>
      </div>
