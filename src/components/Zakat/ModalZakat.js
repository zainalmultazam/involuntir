...
const ModalZakat = ({ onClickOutside, ModalOn, setModalOn }) => {
  ...
  return (
    <div className="mx-auto">
      {pilihPembayaran ? (
        <div className="bg-white w-full fixed z-40 h-screen overflow-x-hidden overflow-y-auto">
                  ...
                  <div className="relative flex content-center my-6">
                    <div className="relative grow">
                      <div className="absolute inset-y-0 left-4 flex items-center pl-4 pointer-events-none">
                        <p className="text-2xl text-peduly-dark font-semibold">
                          Rp
                        </p>
                      </div>
                      <input
                        className=" text-peduly-primary text-2xl font-semibold text-right rounded-full border-0 bg-[#f2f2f2] block w-full h-[72px]  pl-[70px] pr-8 py-5 focus:outline-none focus:border0 focus:ring-0 focus:ring-transparent placeholder-[#E7513B]"
                        type="text"
                        value={value}
